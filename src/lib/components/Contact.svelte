<section id="contact" class="py-16 bg-base-200">
  <div class="container mx-auto px-4 max-w-6xl">
    ...
    <div class="card bg-base-100 shadow-xl max-w-lg mx-auto">
      <div class="card-body">
        ...
        <fieldset class="fieldset">
          ...
          <textarea class="textarea h-24 w-full" placeholder="Your message..."></textarea>
        </fieldset>
    ...
    <div class="divider mt-16">Or connect via</div>
    
    <div class="flex justify-center gap-4 mt-8">
      <a href="#" class="btn btn-circle btn-lg btn-outline">
