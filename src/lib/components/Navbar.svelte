...
<div class="navbar bg-base-100 shadow-sm sticky top-0 z-50">
  <div class="navbar-start">
    <a href="#hero" class="btn btn-ghost text-lg">Nathan Gaul</a>
  </div>
  ...
  <div class="navbar-end">
    <label class="swap">
      <input type="checkbox" class="theme-controller" data-toggle-theme="dim,nord" data-act-class="ACTIVECLASS" bind:checked={isDarkMode} />
